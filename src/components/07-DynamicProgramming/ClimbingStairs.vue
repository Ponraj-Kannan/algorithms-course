...
.ll-root {
  ...
  display: flex; flex-direction: column; height: 75vh; overflow: hidden; width: 100%;
}
...
.ll-pre { font-family: 'Cascadia Code', 'Fira Code', 'Consolas', monospace; font-size: 11px; line-height: 1.5; white-space: pre; color: var(--text); margin: 0; min-height: 600px;}
...
.ll-info-scroll { flex: 1; overflow: auto; padding: 12px 16px; background: var(--surface); color: var(--text2); font-size: 12px; line-height: 1.55; padding-bottom:100px;}
